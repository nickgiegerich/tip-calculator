...
const moneySvg = "/assets/icon-dollar.svg";
const personSvg = "/assets/icon-person.svg";
      ...
      <div className="flex flex-col h-screen justify-center">
        <div className="flex flex-row justify-center">
          <div className="grid grid-cols-1 pb-20">
            <img alt="Logo" src={logo} height="50px" width="75px" layout="intrinsic" />
          </div>
        </div>
            ...
            <div>
              <div className="grid grid-cols-1 gap-3">
                ...
                <div className="relative flex w-full flex-wrap items-stretch mb-3">
                  <span className="z-10 h-full leading-snug font-normal absolute text-center bg-transparent rounded text-base items-center justify-center  pl-3 pt-1">
                    <img alt="Money" src={moneySvg} height={15} width={10} />
                  </span>
                  <input
              ...
              <div className="grid grid-cols-2 gap-3 pt-8">
                ...
                <div className="relative flex w-full flex-wrap items-stretch mb-3 col-span-2">
                  <span className="z-10 h-full leading-snug font-normal absolute text-center bg-transparent rounded text-base items-center justify-center  pl-3 pt-1">
                    <img alt="Person" src={personSvg} height={15} width={10} />
                  </span>
                  <input
